...
class _KawaiiResumePageState extends State<KawaiiResumePage>
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          ...
                          showDialog(
                            context: context,
                            builder: (context) => const KawaiiTicTacToeDialog(),
                          );
                        },
                        style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.pink.shade300,
  ...
  // Helper UI builders omitted for brevity (they remain identical to your original code)
  Widget _buildCuteSectionTitle(String title, Color color) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 25, vertical: 15),
      decoration: BoxDecoration(
...
// ==========================================
// CUTE TIC TAC TOE MINIGAME DIALOG
// ==========================================
// ==========================================
// CUTE TIC TAC TOE MINIGAME DIALOG
// ==========================================
class KawaiiTicTacToeDialog extends StatefulWidget {
  const KawaiiTicTacToeDialog({super.key});

  @override
  State<KawaiiTicTacToeDialog> createState() => _KawaiiTicTacToeDialogState();
}

class _KawaiiTicTacToeDialogState extends State<KawaiiTicTacToeDialog> {
  // Keeps track of the board state. Empty strings mean the cell is empty.
  ...
  void _handleTap(int index) {
    if (_board[index] == '' && _winner == '') {
      setState(() {
        _board[index] = _isPlayer1Turn ? 'Player1' : 'Player2';
        ...
        child: Column(
          ...
          children: [
            ...
            if (_winner == '')
              ...
              ).animate(key: ValueKey(_isPlayer1Turn)).scale()
            else
              Text(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: _board[index] == ''
                            ? null
                            : Image.asset(
                                _board[index] == 'Player1'
                                    ? 'assets/x.png' // Make sure this matches your asset name
                                    : 'assets/o.png', // Make sure this matches your asset name
                                fit: BoxFit.contain,
                              ).animate().scale(
...
// ==========================================
// EXISTING CLASSES (Carousel & Sparkles)
// ==========================================
class CuteCarousel extends StatefulWidget {
  final List<Widget> items;
  final double height;
